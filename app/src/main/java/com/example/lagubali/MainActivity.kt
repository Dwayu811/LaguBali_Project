...
class MainActivity : AppCompatActivity() {
    ...
    private val daftarGending = arrayOf(
        Gending("Meong-Meong", "Ciptaan: Anonim / Tradisional Bali.", R.drawable.meong_meong, R.raw.meongmeong),
        Gending("Made Cenik ", "Ciptaan: Anonim / Tradisional Bali.", R.drawable.made_cenik, R.raw.madecenik),
        Gending("Ratu Anom", "Ciptaan: Anonim / Tradisional Bali.", R.drawable.ratu_anom, R.raw.ratuanom),
        Gending("Sekar Emas ", "Ciptaan: Anonim / Tradisional Bali.", R.drawable.sekar_emas, R.raw.sekaremas),
        Gending("Juru Pencar ", "Ciptaan: Anonim / Tradisional Bali.", R.drawable.juru_pencar, R.raw.jurupencar),
        Gending("Adi Sayang", "Ciptaan: Okid.", R.drawable.adi_sayang, R.raw.adisayang),
        Gending("Curik Curik", "Ciptaan: Anonim / Tradisional Bali.", R.drawable.curik_curik, R.raw.curikcurik),
        Gending("Semut Api ", "Ciptaan: Anonim / Tradisional Bali.", R.drawable.semut_api, R.raw.semutapi),
        Gending("Dadong Dauh ", "Ciptaan: Anonim / Tradisional Bali.", R.drawable.dadong_dauh, R.raw.dadongdauh),
        Gending("Goak Maling ", "Ciptaan: Made Taro.", R.drawable.goak_maling, R.raw.goakmaling),
        Gending("Jenggot Uban ", "Ciptaan: Anonim / Tradisional Bali.", R.drawable.jenggot_uban, R.raw.jenggotuban),
        Gending("Kaki Sayang ", "Ciptaan: A.A Made Cakra.", R.drawable.kaki_sayang, R.raw.kakisayang),
        Gending("Majangeran ", "Ciptaan: Anonim / Tradisional Bali.", R.drawable.majangeran, R.raw.majangeran),
        Gending("Pangelong ", "Ciptaan: Anonim / Tradisional Bali.", R.drawable.pangelong, R.raw.pangelong),
        Gending("Peteng Bulan ", "Ciptaan: Anonim / Tradisional Bali.", R.drawable.peteng_bulan, R.raw.petengbulan),
        Gending("Macepet Cepetan ", "Ciptaan: Anonim / Tradisional Bali.", R.drawable.macepet_cepetan, R.raw.macepetcepetan),
        Gending("Pitutur Guru ", "Ciptaan: Anonim / Tradisional Bali.", R.drawable.pitutur_guru, R.raw.pituturguru),
        ...
        Gending("Putri Cening Ayu ", "Ciptaan: Anonim / Tradisional Bali.", R.drawable.putri_cening_ayu, R.raw.putriceningayu),
